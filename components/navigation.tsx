  ...
  <motion.nav
    ...
    <nav className="relative top-0 z-50 bg-transparent ">
      <div className="">
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className=" md:hidden p-5 pr-0 pt-5 pb-16 top-0 left-0 right-0 absolute bg-white">
            {/* Mobile Menu Button */}
          <div className="flex flex-row w-full justify-between z-50">
            ...
            <div className="flex flex-col gap-3 z-50 pt-20 pl-6 items-start">
              ...
              <button
                ...
                className="px-4 py-2 text-left text-gray-500 hover:bg-gray-100 rounded-lg transition-colors text-sm font-medium flex items-center justify-between w-full"
              >
                More
              ...
              {isMoreOpen && (
                <div className="w-full py-3 px-4 bg-gray-300 rounded-xl flex items-center self-center justify-center flex-col text-center">
                  {moreLinks.map((link: NavLink) => (
                    <Link
                      key={link.href}
                      href={link.href}
