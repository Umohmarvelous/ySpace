...
// }
// const NavItem: React.FC<NavItemProps> = memo(({ link, isActive, onClick }) => {
...
//       : 'text-gray-500 hover:text-zinc-400 border-transparent'
//   }`;
// return (
//     <Link
//       key={link.href}
...
//                 <button className="flex items-center gap-1 text-gray-500 hover:text-gray-900 p-3 rounded-full transition-colors text-sm font-medium">
//                   Services
...
//             >
//               {isOpen ? <X className="w-5 h-5 text-white" /> : <Menu className="w-5 h-5 text-black" />}
//             </button>
    ...
    <nav className="relative top-0 z-50 bg-transparent">
      <div className="flex-1 items-center justify-center">
        ...
        <div className="pt-5 flex flex-row items-center justify-between w-auto h-auto">
          ...
          <div className="hidden md:items-end md:justify-self-end md:flex md:flex-row items-center right-0 relative gap-4 mx-6 w-fit">
            <button className={`p-2 rounded-full transition-colors `}>
              <ShoppingCart className={`w-5 h-5 inline-block text-gray-700 border-2 border-red-500 ${iconColor}`} />
            </button>
          </div>
          ...
          <div className="md:hidden p-2 flex flex-row-reverse px-6">
            <button
              ...
              aria-expanded={isOpen}
            >
              {isOpen ? <X className={`w-5 h-5 ${iconColor}`} /> : <Menu className={`w-5 h-5 `} />}
            </button>
            <button className="pr-6 rounded-full transition-colors">
        ...
        {isOpen && (
          <div className={`md:hidden p-5 pr-0 pt-8 pb- z-50 top-0 left-0 right-0 absolute bg-white`}>
              ...
              <div className="flex flex-col gap-3 z-50 pt-8 pl-2 items-start self-start pr-4 pb-12">
                  ...
                  <button
                    onClick={() => setIsServiceOpen(!isServiceOpen)}
                    className={`px-5 py-2 text-left ${inactiveTextColor} ${hoverTextColor} rounded-lg transition-colors text-sm font-medium flex items-start self-start justify-between w-full hover:text-white `}
                    >
                    Services
