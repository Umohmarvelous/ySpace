    ...
    <>
      ...
      <div className="bg-white">
        ...
        <motion.section
          ...
          className="relative w-full h- md:h-auto pt-0 md:pt-32 pb-20 flex items-center justify-center text-center text-white overflow-hidden"
          style={{
            backgroundImage: "url('/Vendor_Hero_Img.svg')",
        ...
        >
          ...
          <div className=" z-10 max-w-auto md:max-w-2xl px-6 pb-3 w-full relative ">
            <motion.div
            ...
            >
              <h1 className=" text-center md:text-left text-4xl md:text-5xl font-bold mb-2 md:mb-6 leading-tight pt-32">
                Sell Smarter. Deliver Faster with Yspace
              </h1>
              <p className="w-auto px-5 md:px-0 text-center md:text-left text-xl md:text-lg mb-0 md:mb-8">
