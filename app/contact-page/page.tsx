    ...
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className={`bg-gray-100 border-0 rounded-lg py-3 px-4 text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-purple-500 ${
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <Select value={formData.countryCode} onValueChange={handleCountryCodeChange}>
            <SelectTrigger className="w-24 bg-gray-100 border-0 rounded-lg py-3 px-4 text-gray-900 focus:ring-2 focus:ring-purple-500">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
          ...
          <Input
            ...
            className={`flex-1 bg-gray-100 border-0 rounded-lg py-3 px-4 text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-purple-500 ${
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          rows={6}
          className="bg-gray-100 border-0 rounded-lg py-3 px-4 text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-purple-500 resize-none"
        />
      </div>
